<template>
  <transition name="fade">
    <div class="switch-settings-card">
      ...
      <hr>
      <div class="placeholder">Lamp groups will be displayed here in the future to connect switches to groups.</div>
...
export default {
  ...
  methods: {
    ...mapActions('switches', ['setDefaultFloorHeight']),
