// panels.js - Store module for electrical panels
export const panels = {
    namespaced: true,
    state: {
        objects: [], // List of placed panels
        currentConfig: {
            type: 'main-panel', // 'main-panel', 'sub-panel', 'distribution-box'
            size: 400, // 40cm = 400mm
            heightFromFloor: 1200, // Default height from floor in mm (120cm)
